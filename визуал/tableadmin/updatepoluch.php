...
if(isset($_POST['ID']) && isset($_POST['Fum'])){
  ...
  $query ="UPDATE `Получатель` SET `ID получателя` ='$ID', `Фамилия`='$fum',`Имя`='$name',`Отчество`='$otch',`Телефон`='$num',`Индекс`='$ind',`Город`='$city',
  `Улица`='$street',`Дом`='$home',`Квартира`='$cvart' WHERE `ID получателя`='$ID'";
